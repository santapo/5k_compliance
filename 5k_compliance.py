...
if __name__ == "__main__":
    ...
    detection_list = detect_mask_images(image_path_list, args["face_weight"], args["mask_weight"], args["detect_confidence"], visualize=False)
    import ipdb; ipdb.set_trace()
    result_list = []
    distancing_compliance_df = pd.read_csv('distancing.csv')
    for locs, preds, image_path in detection_list:
        ...
        is_distancing_compliance = int(distancing_compliance_df.loc[distancing_compliance_df['fname']==image_name]['distancing'])
        ...
        result_list.append((image_name, is_5k_compliance))
    import ipdb; ipdb.set_trace()
    meta_path = "/home/santapo/OnlineLab/challenges/5k_compliance_zalo/5k_compliance/data/public_test/public_test_meta.csv"
